...
function Neo4jD3(_selector, _options) {
    ...
    //             //    })
    //                 .attr('width', function(d) {
    //                     // console.log(d.id + " " + d.id.length + " " + toString(d).length);
    //                     return toString(d).length + 50;
    //                 })
    //                 .attr('height', '50')
    ...
    function appendTextToNode(node) {
        return node.append('text')
                   ...
                   .attr('font-size', function(d) {
                       return icon(d) ? (options.nodeRadius + 'px') : '20px';
                   })
                   .attr('pointer-events', 'none')
                   .attr('text-anchor', 'middle')
                   .attr('y', function(d) {
                       return icon(d) ? (parseInt(Math.round(options.nodeRadius * 0.32)) + 'px') : '4px'; // This was 4px
                   })
